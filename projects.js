export const projects = [
  {
    ...
    image: "https://t-dev.no/api/t-dev/spacex.png",
  },
  {
    id: 2,
    keyword: "E-commerce",
    ...
    paragraph:
      "The assignment was to create an e-commerce website that has both customer-facing and admin sections. The website was populated by my own API. On the right is a gif of the admin section of the website. I also created a register form that register users on the API with a token and key.",
    grades: null,
    site: "https://t-dev.no/semester-project/",
    github: "https://github.com/TrondSpjelkavik/semester-project",
    image: "https://t-dev.no/api/t-dev/moomin-store-gif.gif",
  },

  {
    ...
    paragraph:
      "The Go language is advanced and reliable, offering great built-in ways to handle error. It is efficient, compiling down to one binary. Go enhances the availability and reliability of services and increases code readability through its simplicity.",
    grades: null,
    site: null,
